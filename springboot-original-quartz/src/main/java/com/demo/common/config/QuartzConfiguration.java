...
public class QuartzConfiguration {
	...
	/**
	 * 配置JobFactory,为quartz作业添加自动连接支持,Quartz中的job自动注入spring容器托管的对象
	 */
    @Bean
	...
	@Bean
	public Scheduler scheduler(ApplicationContext applicationContext) throws IOException, SchedulerException {
